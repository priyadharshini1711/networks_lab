...
class Subnet {
    public static void main(String args[]) {
        ...
        System.out.println(“Number of bits required
            for address = “+bits);
        int mask = 32 - bits;
        ...
        System.out.println();
        int lbip[] = new int[32];
        for (int i = 0; i < 32; i++) lbip[i] = (int) bip.charAt(i) - 48; //convert character 0,1 to integer 0,1 for(int i=31;i>31-bits;i–) //Get last address by ORing last n bits with 1 
        lbip[i] |= 1;
        String lip[] = {“”,
            ””,
            ””,
